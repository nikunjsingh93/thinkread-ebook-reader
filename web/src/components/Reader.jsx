...
import { apiSaveBookmark, apiDeleteBookmark, apiGetBookmarks, apiGetBookFileUrl, apiGetFontFileUrl, apiGenerateTTS, apiGetTTSVoices, apiSaveTTSProgress, apiGetTTSProgress, apiDeleteTTSProgress } from "../lib/api.js";
...
export default function Reader({ book, prefs, onPrefsChange, onBack, onToast, bookmarkCfi, bookmarkUpdateTrigger, isOffline, onUiVisibleChange, onBookmarkChange }) {
          ...
          if (behavior === 'volumeDownNext') {
            ...
            if (data.key === 'volumeDown') {
              if (rendition) rendition.next();
                ...
                const viewer = document.querySelector('.pdf-vertical-scroll-container');
  ...
  }, [prefs.volumeKeyBehavior, book.type]);
